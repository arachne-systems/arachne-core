...
| `arachne-iroh-blobs` (upstream `iroh-blobs`) | 0.103.0 | MIT OR Apache-2.0 | [n0-computer/iroh-blobs](https://github.com/n0-computer/iroh-blobs) | [licenses](vendor/iroh-blobs/) · [patch notes](vendor/iroh-blobs/ARACHNE-PATCH.md) |
| `arachne-iroh-gossip` (upstream `iroh-gossip`) | 0.101.0 | MIT OR Apache-2.0 | [n0-computer/iroh-gossip](https://github.com/n0-computer/iroh-gossip) | [licenses](vendor/iroh-gossip/) · [patch notes](vendor/iroh-gossip/ARACHNE-PATCH.md) |
